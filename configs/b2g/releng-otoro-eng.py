...
config = {
    ...
    "upload": {
        ...
        "public": {
            ...
            "post_upload_cmd": "post_upload.py --tinderbox-builds-dir ${branch}s-%(target)s -p b2g -i %(buildid)s --revision %(revision)s --builddir en-US --release-to-tinderbox-dated-builds",
            "post_upload_nightly_cmd": "post_upload.py --tinderbox-builds-dir %(branch)s-%(target)s -b %(branch)s -p b2g -i %(buildid)s --revision %(revision)s --builddir en-US --release-to-tinderbox-dated-builds --release-to-latest --release-to-dated",
        },
    },
